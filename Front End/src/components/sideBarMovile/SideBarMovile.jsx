...
export const SideBarMovile = ({state,setState}) => {
    ...
    return ( 
        ...
        `} >
            <div className=" w-80 h-screen flex flex-col justify-center bg-[hsl(209,92%,5%)] ">  
                <div className="w-full h-14"></div>
                <div className="flex text-3xl font-macondo font-bold gap-2  ml-10 text-[rgb(221,237,115,255)] text-aura-parentesis">/*</div>
